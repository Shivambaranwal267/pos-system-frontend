    ...
    >
      <DialogContent>
        ...
        <div className="bg-background max-h-96 overflow-y-auto">
          <div>
            <h3 className="font-bold text-lg">Mumbai D_MART Goregaon West</h3>
            <p>123 Bangur Nagar, Goregaon West, Mumbai</p>
            <p>Tel: 022-28796543</p>
          </div>
